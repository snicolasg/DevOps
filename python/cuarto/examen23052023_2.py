...
for item in lista_items: 
    ...
    densidad = float(elementos[2]) / float(elementos[1])


    print(f"Ítem: {elementos[0]}\tVolumen: {elementos[1]}\tPeso: {elementos[2]}\tDensidad: {densidad}")

#print(f"Ítem {elementos[0]}\tVolumen {elementos[0]}\tPeso {elementos[2]}\tDensidad {elementos[2]*elementos[1]}")
